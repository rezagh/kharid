...
<head>
	...
	<script>
	function ss(){
		  DwrManager.getVisaCards(function(item) {



			var cellFunc = [
							  function(i) {return i.order;},
			                  function(i) {return i.usdPrice;},
			                  function(i) {return i.audAmount;},
			                  function(i) {return i.price;},
			                  function(i) {return i.physicalPrice;}
	                  ];

			dwr.util.addRows( "cc_table", item,cellFunc);
	  ...
	  function getMaster(amount){
		...
		if(a > 1000){
		  ...
		  DwrManager.getMasterCardDetail(a,function(item) {
...
نکاتی که باید بدانید
			...
			<ul style="font-size: small;">
				...
				<li>ارز کارتها دلار استرالیاست و در خریدهای با ارز دیگر ممکن است 2.5% برای Master و 3.5% برای Visa ( یا کمتر ) کارمزد کسر شود</li>
				...
				<li>این کارت ها از نوع "کارت هدیه" هستند و به شخص یا آدرس خاصی ارتباط ندارند</li>
				...
				<li>خرید سامان مسولیتی در قبال سایت هایی که کارت اعتباری هدیه قبول نمیکنند نمیپذیرد و کارت فروخته شده پس گرفته نمیشود.</li>
