...
import com.kharid.model.type.InquiryTypeEnum;
...
public class InquiryController extends ParentMultiAction{
	...
	public ModelAndView ccInquiry(HttpServletRequest request, HttpServletResponse response, InquiryDO inquiry) throws Exception {
	...
	public ModelAndView listInquiryPage(HttpServletRequest request, HttpServletResponse response, InquiryDO inquiry) throws Exception {
		request.getSession().setAttribute("inquiryTypes",InquiryTypeEnum.values() );
		
		return new ModelAndView("inquiry");
    }

	public ModelAndView submitSurvey(HttpServletRequest request, HttpServletResponse response, InquiryDO inquiry) throws Exception {
