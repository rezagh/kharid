...
public class YahooExchange implements ExchangeFetch {
	...
	public Map<String,Double> getExchangeRates() {
		...
		map.put("USD_AUD",getExchangeRate(UrlUtil.readUrlToString(Constant.get("YAHOO_EXCHANGE_URL_USD_TO_AUD"))));
		map.put("AUD_USD",getExchangeRate(UrlUtil.readUrlToString(Constant.get("YAHOO_EXCHANGE_URL_AUD_TO_USD"))));
		map.put("GBP_AUD",getExchangeRate(UrlUtil.readUrlToString(Constant.get("YAHOO_EXCHANGE_URL_GBP_TO_AUD"))));
		map.put("EUR_AUD",getExchangeRate(UrlUtil.readUrlToString(Constant.get("YAHOO_EXCHANGE_URL_EUR_TO_AUD"))));
